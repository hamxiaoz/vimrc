...
" markdown z
syn case match
syn match zContext '@\w\+' containedin=markdownCodeBlock
syn keyword zKeyword WAIT REF containedin=markdownCodeBlock
syn match zTodoComplete '^\s*x'
syn match zTodo '^\s*?\+'
" doesn't work
syn match zImportant '\s+!!\s\+'

hi def link zKeyword Todo
hi def link zContext htmlLink
hi def link zTodoComplete Comment
hi def link zTodo Todo
hi def link zImportant Todo
syn case ignore
"""""""""""""""""""""""""""""""""""
...
let b:current_syntax = "markdownz"
